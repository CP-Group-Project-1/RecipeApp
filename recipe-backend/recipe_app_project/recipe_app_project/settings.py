"""
Django settings for recipe_app_project project.
...
SECRET_KEY = 'django-insecure-*nv8pp*f4%i-$59fgko9^l)1*wdmdzubiznwjf#nme(5qkf%l&'
...
WSGI_APPLICATION = "recipe_app_project.wsgi.application"
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication', # Use this to disable authentication during development
    ]
}
